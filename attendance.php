...
/* Fetch all agent events then compute attendance */
...
$attendanceData = computeAttendanceData($dailyAgentEvents);
ksort($attendanceData);

if ($format === 'excel') {
    streamExcelAttendance($dailyAgentEvents, $from, $to);
    exit;
}

require __DIR__ . '/ui/attendance.php';
